...
<html lang="en">
  ...
  <body>    
    ...
    <!--=========== END COURSE BANNER SECTION ================-->
        ...
        <%
            ArrayList<VSMShareDetail> al1;
            if(request.getAttribute("shares")!= null)
            {
                   al1 = (ArrayList<VSMShareDetail>) request.getAttribute("shares");
                   
                   for(VSMShareDetail v : al1) {    
          %>
          <tr> 
              ...
              <td><%=v.getName()%>
              <td><%= v.getPrice()%> </td>
              <td><%= v.getPreviousopen() %></td>
              <td><%= v.getPreviousclose() %></td>
              <td><%= v.getLow() %></td>
              <td><%= v.getHigh() %></td>
              <td><%= v.getChange() %></td>
              <td><%= v.getChangeinpercentage() %></td>
