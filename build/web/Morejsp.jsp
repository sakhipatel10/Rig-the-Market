...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Rig The Market:Indices</title>
  ...
  <body>    
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                <li class="active"><a href="Morejsp.jsp">Indices</a></li>
    ...
    <!--=========== END COURSE BANNER SECTION ================-->
        ...
        <%
            ...
            {
                   shareList = (ArrayList<VSMShareDetail>) request.getAttribute("symbol");
                   
                   for(int i =0 ; i<11;i++)
                   {
                       VSMShareDetail s = shareList.get(i);
          %>
          <tr>
