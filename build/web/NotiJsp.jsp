...
<html lang="en">
  ...
  <body>    
    ...
    <div id="tfheader">
		<form id="tfnewsearch" method="get" action="SearchSetServ">
                    <p>Enter Shares name :</p>
		        <input type="text" size="100" class="tftextinput" name="search"  maxlength="120"><input type="submit" value="Set" class="tfbutton">
		</form>
	<div class="tfclear"></div>
        ...
        <table> 
          ...
          <tr> 
              ...
              <td> <%= s.getName()%> </td>
              <td><%= s.getPrice()%> </td>
              <td><a href="NotificationServ?id=<%=s.getSymbol()%>"><button class="buybutton button1">Set</button></a></td>
          </tr>
                  <%} 
            }
        %>
