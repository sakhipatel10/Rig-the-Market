              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog">
                    ...
                    <div>
                        <h2>View Your Track Of Profit or Loss</h2>
                        <h4><font color="blue"> View Overall Profit-Loss </font></h4>
                        <p>.</p>
                        <form action="ProfitLossServ">
                        <div class="fsButton"><button name="button" value="OK" type="submit"> OverAll Profit-Loss</button></div>
                        </form>
                        <br>
                        <h4><font color="blue"> Profit-Loss Company wise </font></h4>
                        <form action="">
                            <div class="fsButton"><button name="button1" value="OK" type="submit">Profit-Loss Company wise</button></div>
                        </form>
                        <br>
                        <br>
                    </div>    
