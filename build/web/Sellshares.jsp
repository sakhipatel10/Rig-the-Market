...
<html lang="en">
  ...
  <body>    
    ...
    <section id="imgBanner">
      <h2>Sell Your Shares</h2>
      <h4><font color="white">The listed below shares are the total shares you are holding.</font></h4>
    </section>
    ...
    <% 
        ArrayList<Myshares>al;
        if(request.getAttribute("symbol")!= null)
        {
         al =(ArrayList<Myshares>)request.getAttribute("symbol");
         ...
         for(Myshares m  : al){
            ...
            <tr>
                ...
                <td><%=m.getName()%></td>
                <td><%=m.getQuantity()%></td>
                <td><a href="ButtonSellServ?id=<%=m.getSymbol()%>"><button class="buybutton button1">Sell</button></a></td>
            </tr>
            <%}
}
%>
