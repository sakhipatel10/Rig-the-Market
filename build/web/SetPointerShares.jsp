  ...
  <body>    
    ...
    <div class="SearchShare">
     <%
            ...
            {
                VSMShareDetail vsm = (VSMShareDetail)request.getAttribute("share");  
            %>
            <p>Symbol:<%=vsm.getSymbol()%></p>
            <p>Name:<%=vsm.getName()%></p>
            <p>Price:<%=vsm.getPrice()%></p>
            <p>Previous Open:<%=vsm.getPreviousopen()%></p>
            <p>Previous Close:<%=vsm.getPreviousclose()%></p>
            <form action="SetPointerServ">
            <p> Enter Maximum Value of shares to set pointer : <input type="text" name="Maximum"><br></p>
            <p> Enter Minimum Value of shares to set pointer : <input type="text" name="Minimum"><br></p>
            <input type="hidden" name="symbol" value="<%=vsm.getSymbol()%>" />
            <p><button class="buybutton button1">Set</button></p>
            </form>
            <%}%>
    </div>
