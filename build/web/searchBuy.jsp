  ...
  <body>    
    ...
    <div class="SearchShare">
     <%
            ...
            <form action="BuyingShareServ">
            <p> Enter the quantity you want to BUY: <input type="text" name="buyquantity"><br></p>
            <input type="hidden" name="symbol" value="<%=vsm.getSymbol()%>" />
            <input type="hidden" name="name" value="<%=vsm.getName()%>" />
            <input type="hidden" name="bprice" value="<%=vsm.getPrice()%>" />
            <p><button class="buybutton button1">Buy</button></p>
            </form>
            <%}%>
    </div>
