...
<html lang="en">
  ...
  <body>    
    ...
    <section id="imgBanner">
      <h4> </h4>
      <h3><font color="white">Add shares that you want to watch in Watchlist</font></h3>
    </section>
    <!--=========== END COURSE BANNER SECTION ================-->
    <div>
        <form action ="WatchlistServ">     
   <h2><font color="blue">Press Button to watch list of shares in Watchlist</font></h2>
   <div class="fsButton"><button name="button" value="OK" type="submit">View Shares</button></div>
        ...
        <table> 
          ...
          <tr> 
              ...
              <td> <%= s.getName()%> </td>
              <td><%= s.getPrice() %> </td>
              <td><a href="AddedWatclistServ?id=<%=s.getSymbol()%>"><button class="buybutton button1">ADD</button></a></td>
          </tr>
                  <%} 
            }
        %>
