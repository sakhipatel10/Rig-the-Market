  ...
  <body>    
    ...
    <div class="SearchShare">
     <%
            ...
            {
            Myshares  m = (Myshares)request.getAttribute("share");
            %>
            <p>Symbol:<%=m.getSymbol()%></p>
            <p>Name:<%=m.getName()%></p>
            <p>Quantity you have:<%=m.getQuantity()%>
            <form action="SellingShareServ">
            <p> Enter the quantity you want to Sell: <input type="text" name="sellquantity"><br></p>
            <input type="hidden" name="symbol" value="<%=m.getSymbol()%>" />
            <input type="hidden" name="name" value="<%=m.getName()%>" />
            <p><button class="buybutton button1">Sell</button></p>
            </form>
            <%}%>
    </div>
