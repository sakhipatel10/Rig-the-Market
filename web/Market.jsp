...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Rig The Market:Market Watch</title>
  ...
  <body>    
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li class="active"><a href="MarketWatch">Market</a></li>
    ...
    <section id="imgBanner">
      <h2>Equity Shares</h2>
      <h4><font color="white">Price is what you pay; value is what you get.Whether we were talking about socks or stocks, I like buying quality merchandise when it is marked down</font></h4>
    </section>
	...
	<div id="tfheader">
		<form id="tfnewsearch" method="get" action="SearchShareServ">
                    <p>Enter Shares name :</p>
		        <input type="text" size="100" class="tftextinput" name="search"  maxlength="120"><input type="submit" value="search" class="tfbutton">
		</form>
	<div class="tfclear"></div>
        ...
        <%
          ...
          <tr> 
              <td> <%= s.getSymbol()%></td>
              <td><a href="graph?id=<%=s.getId()%> "> <%= s.getName()%></a> </td>
              <td><%= s.getPrice() %> </td>
              <td><%= s.getPreviousopen() %></td>
              <td><%= s.getPreviousclose() %></td>
              <td><%= s.getLow() %></td>
              <td><%= s.getHigh() %></td>
              <td><%= s.getChange() %></td>
