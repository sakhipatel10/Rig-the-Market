...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Rig The Market:Notification</title>
              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog">
                    ...
                    <div>
                        <h2>Add Your Shares:</h2>
                        <h4><font color="blue"> Set Pointer on desired Shares:</font></h4>
                        <p></p>
                        <form action="NotiServ">
                        <div class="fsButton"><button name="button" value="OK" type="submit">Set pointer</button></div>
                        </form>
                        <br>
                        <h4><font color="blue"> View Set Shares : </font></h4>
                        <form action="BuyShareServ">
                            <div class="fsButton"><button name="button1" value="OK" type="submit">View And Edit Pointer</button></div>
                        </form>
                        <br>
                        <br>
                    </div>    
