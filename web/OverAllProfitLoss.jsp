<%@page import="model.MyHistory"%>
<%@page import="java.util.ArrayList"%>
<%@page import="Controller.MyHistoryServ"%>
<!DOCTYPE html>
<html lang="en">
  <head>
    <!--=============================================== 
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Rig The Market:profitLoss</title>
  ...
  <body>    
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                ...
                <li class="active"><a href="ProfitLoss.jsp">Profit/loss</a></li>             
    ...
    <table>
        ...
        <th>Selling Date and Time</th>
        <th>Buying Quantity</th>
        <th>Selling Quantity</th>
        <th>Buying Total price</th>
        <th>Selling Total Price</th>
        <th>Virtual Money Left</th>
        <th>Virtual Money Added</th>
        <th>Profit Loss</th>
     <%
            ArrayList<MyHistory> shareList;
            if(request.getAttribute("shares")!= null)
            {
                   shareList = (ArrayList<MyHistory>) request.getAttribute("shares");
                 
                   for(MyHistory m : shareList)
                   {
        ...
        <tr>
          <td><%= m.getType()%> </td>
              ...
              <td><%= m.getBprice()%> </td>
                      <td><%= m.getSprice()%> </td>
                      <td><%= m.getBDateTime() %> </td>
                      <td><%= m.getSDateTime() %> </td>
                      <td><%= m.getBquantity() %> </td>
                      <td><%= m.getSquantity() %> </td>
                      <td><%= m.getBtotalPrice() %> </td>
                      <td><%= m.getStotalPrice() %></td>
                      <td><%= m.getVml() %></td>
                      <td><%= m.getVma() %></td>
                      <td><%=m.getSellprofitloss() %></td>
                      </tr>
