...
<html lang="en">
  ...
  ====================================================-->
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>Rig The Market:Contact</title>
      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation"> <div class="container">
          <div class="navbar-header">
            ...
            <!-- LOGO -->
            <!-- TEXT BASED LOGO -->
            <a class="navbar-brand" href="index.jsp">Rig The <span>Market</span></a>            
            <!-- IMG BASED LOGO  -->
       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">We are Rig The Market</h2>
              <span></span> 
         ...
         <div class="col-lg-4 col-md-4 col-sm-4">
           <div class="contact_address wow fadeInRight">
             ...
             <div class="address_group">
               <p>SVIT Road, Rajupura Village, Vasad, Gujarat 388306, India</p>
               <p>Phone: 123-456-7890</p>
               <p>Email:rig_the_market@gmail.com</p>
             </div>
             <div class="address_group">
